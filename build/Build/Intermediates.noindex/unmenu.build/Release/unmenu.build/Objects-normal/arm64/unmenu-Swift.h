...
#ifndef UNMENU_SWIFT_H
#define UNMENU_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="unmenu",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6unmenu11AppDelegate")
...
SWIFT_CLASS("_TtC6unmenu10InputField")
...
SWIFT_CLASS("_TtC6unmenu11ResultsView")
...
SWIFT_CLASS("_TtC6unmenu20SearchViewController")
@interface SearchViewController : NSViewController <NSTextFieldDelegate, NSWindowDelegate>
- (void)viewDidAppear;
...
- (void)viewDidLoad;
- (void)interfaceModeChangedWithSender:(NSNotification * _Nonnull)sender;
...
SWIFT_CLASS("_TtC6unmenu12SearchWindow")
...
SWIFT_CLASS("_TtC6unmenu28VerticalAlignedTextFieldCell")
@interface VerticalAlignedTextFieldCell : NSTextFieldCell
...
- (void)editWithFrame:(NSRect)aRect inView:(NSView * _Nonnull)controlView editor:(NSText * _Nonnull)textObj delegate:(id _Nullable)anObject event:(NSEvent * _Nullable)theEvent;
